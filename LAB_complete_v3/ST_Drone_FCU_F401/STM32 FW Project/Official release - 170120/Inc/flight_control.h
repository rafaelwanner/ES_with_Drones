...
#include "motor.h"
  ...
  #define THR_GAIN			0.4f				//ETH   outdoor usage: 0.6f - indoor:
#endif
#ifdef MOTOR_ESC
...
//#define ROLL_PID_KP1         3          /* default */
#define ROLL_PID_KP1         10          /* test minidrone */
...
#define ROLL_PID_KI2         200        /* test minidrone */
...
#define max_throttle_limit		 200
#define min_throttle_limit		-200
